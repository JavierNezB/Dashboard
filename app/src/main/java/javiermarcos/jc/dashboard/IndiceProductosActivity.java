...
public class IndiceProductosActivity extends AppCompatActivity {

    private PieChart pieChart;
    private BarChart barChart1;

    //datos del eje horizontal eje X
    private String[] months1 = new String[]{"Coca Cola Alvaro Obregon", "Coca Cola Benito Juarez", "Coca Cola  Alvaro Obregon", "Coca Cola Azcapotzalco", "Coca Cola Light Alvaro Obregon"};
    //datos del eje vertical eje Y
    private int[] sale1 = new int[]{189000 , 165000, 150000, 145000, 50000};
    //Colores de nuestra gafica
    private int[] colors1 = new int[]{Color.rgb(232, 245, 102),
            Color.rgb(178, 245, 102), Color.rgb(102, 245, 184),
            Color.rgb(102, 193, 245), Color.rgb(117, 102, 245)};

    @Override
    protected void onCreate(Bundle savedInstanceState) {

        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_indice_productos);
    ...
    public void createChats() {
        ...
        pieChart=(PieChart) getSameChart(pieChart, "Ventas Top 5 de todas las zonas", Color.BLACK, Color.TRANSPARENT, 3000);
        //circulo de en medio
